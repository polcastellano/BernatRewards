        ...
        <div class="infoUsuario">
            ...
            <div v-if="user.experience < 100000" class="nivelInfo d-flex flex-column">
                <div class="d-flex justify-content-between">
                    ...
                    <p><span style="font-weight: bold;">{{ user.experience }}</span>/{{ user.nextLevel.experiencia }}xp
                    </p>
            ...
            <div v-else class="nivelInfo d-flex flex-column">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <p>Nv.Max</p>
                        <img src="/images/iconos/lvlMax.svg" class="logo d-none d-lg-block" style="height: 1.5rem;"/>
                    </div>
                </div>
