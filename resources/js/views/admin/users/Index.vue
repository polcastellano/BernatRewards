                ...
                <div class="card-body shadow-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <tr v-for="post in users.data" :key="post.id" class="minH">
                                ...
                                <td class="px-6 py-4 text-sm d-flex">
                                    <router-link v-if="can('user-edit') && authUser.roles[0].name == post.roles[0].name || post.roles[0].name == 'user' || can('user-all')" :to="{ name: 'users.edit', params: { id: post.id } }" 
                                    ...
                                    <a href="#" v-if="can('user-delete') && authUser.roles[0].name == post.roles[0].name || post.roles[0].name == 'user' || can('user-all')" @click.prevent="deleteUser(post.id)"
                                    ...
                                    <div v-else style="min-height: 33px !important;"></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
