                        ...
                        <table class="table">
                            ...
                            <tr v-for="post in users.data" :key="post.id" class="minH">
                                ...
                                <td class="px-6 py-4 text-sm d-flex">
                                    <!-- TODO bloquear profes  && authUser.roles[0].name == post.roles[0].name && post.roles[0].name == 'user' -->
                                    <router-link v-if="can('user-edit') || can('user-all')" :to="{ name: 'users.edit', params: { id: post.id } }" 
